...
class ProductModel extends Model
{
    ...
    protected $allowedFields = ['productID', 'productName', 'productBrand', 'categoryID', 'supplierID', 'productDescription', 'unit', 'willExpire', 'buyPrice', 'sellPrice', 'clq','isProductArchived'];
